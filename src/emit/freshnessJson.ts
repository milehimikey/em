...
// 1.2 (MIL-214): `unruledFindings: number | null` and `lastConformance.partial: boolean` ride
// along the same way — see ../cli/status.ts's ConformanceEntry.
export const FRESHNESS_SCHEMA_VERSION = "1.2";
