 ...
 *  diagram and a slice crop of it, note hrefs recomputed for each — see
 ...
 * a full diagram and a slice snippet one directory deeper) must call this twice,
 ...
 *  so a caller can transform the composed string (e.g. cropToSlice) in between
 *  composing and writing it. */
