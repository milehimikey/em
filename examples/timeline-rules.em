...
# enforces, rather than to be a complete domain. Three things to look at:
#
#   1. "Ticket Queue" appears four times. The instances are NOT joined to each
...
#
#   2. "Refund Backlog" is fed by an event twelve slices earlier. That arrow has to
...
#
#   3. Every connection here is one of the four patterns. See timeline-rules-invalid.em
